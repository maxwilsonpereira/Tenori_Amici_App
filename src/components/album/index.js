      ...
      <div className={classes.containerApp}>
        <div className={classes.gridAlbum}>
          <ScrollAnimation animateIn="fadeIn" animateOnce={true} duration={2}>
            <div>
              <img className={classes.imgAlbum} src={ConAmore} />
            </div>
          </ScrollAnimation>
          <ScrollAnimation
          ...
          >
            <div className={classes.backdivwhite}>
              ...
              <a
                ...
                target="_blank"
              >
                <img className={classes.logosMedia} src={Itunes} />
              </a>
              <a
                href="https://at.napster.com/artist/tenori-amici/album/con-amore"
                target="_blank"
              >
                <img className={classes.logosMedia} src={Napster} />
              </a>
              <a
                href="https://open.spotify.com/album/1AkxhGb0UU1N0IxiS9BKPn"
                target="_blank"
              >
                <img className={classes.logosMedia} src={Spotify} />
              </a>
              <br />
              <br />
            </div>
